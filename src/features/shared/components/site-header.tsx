...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-[#e5e5e0] bg-white/95 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:px-6 md:gap-4 md:px-10 lg:px-12">
        <Link
          href="/"
          className="flex min-w-0 items-center gap-2 text-base font-bold text-black"
        >
          <span className="grid size-9 place-items-center rounded-full bg-[#e60023] text-white">
            R
          </span>
