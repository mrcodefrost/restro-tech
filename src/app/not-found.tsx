  ...
  return (
    <section className="flex min-h-[calc(100vh-4rem)] items-center px-6 py-8 md:px-10 lg:px-12">
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center text-center">
        <FadeIn delay={0.1}>
          <p className="relative inline-block text-[56px] font-medium leading-[1.05] tracking-tight text-ink sm:text-[72px]">
            <span className="relative">
              404
              <span
                aria-hidden
                className="absolute -bottom-1 left-0 -z-10 h-2.5 w-full rounded-full bg-brand/60"
              />
            </span>
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.2}>
          <h1 className="mt-4 text-2xl font-medium leading-tight tracking-tight text-ink sm:text-3xl">
            This dish isn&apos;t on the menu.
          </h1>
          <p className="mx-auto mt-3 max-w-md text-base leading-7 text-copy">
